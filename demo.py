...
print(run.read(include=['motor']))
print("...or filter the fields by blacklist (exclude='motor_setpoint')...")
print(run.read(exclude=['motor_setpoint']))
print("Read the primary stream as one structure.")
print(run.primary.read())
print("Filter the fields by whitelist (include='motor')...")
print(run.primary.read(include=['motor']))
print("...or filter the fields by blacklist (exclude='motor_setpoint')...")
print(run.primary.read(exclude=['motor_setpoint']))
