...
import metadataservice.client.commands as mdsc
from metadataservice.client.utils.testing import mds_setup, mds_teardown
from metadataservice.client.examples.sample_data import temperature_ramp
import uuid
...
def check_for_id(document):
    ...
    Parameters
    ----------
    document : metadataservice.client.document.Document
...
# ### Testing metadataservice.client find functionality ################################
...
# ### Test metadataservice.client time formatting ######################################
