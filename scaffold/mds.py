...
class MDSRO(object):
    ...
    def run_start_given_uid(self, uid):
        ...
        """
        return self._api.run_start_given_uid(uid,
                                             self._RUNSTART_CACHE)
    ...
    def descriptor_given_uid(self, uid):
        ...
        """
        return self._api.descriptor_given_uid(uid,
                                              self._DESCRIPTOR_CACHE,
                                              self._RUNSTART_CACHE)
    ...
    def find_run_starts(self, **kwargs):
        ...
        """
        gen = self._api.find_run_starts(self._RUNSTART_CACHE,
    ...
    def find_run_stops(self, **kwargs):
        ...
        """
        gen = self._api.find_run_stops(self._RUNSTART_CACHE,
                                       self._RUNSTOP_CACHE,
                                       self.config['timezone'],
                                       **kwargs)
        for rs in gen:
    ...
    def find_descriptors(self, **kwargs):
        ...
        """
        gen = self._api.find_descriptors(self._RUNSTART_CACHE,
                                         self._DESCRIPTOR_CACHE,
                                         self.config['timezone'],
                                         **kwargs)
        for desc in gen:
    ...
    def find_events(self, **kwargs):
        ...
        """
        gen = self._api.find_events(self._RUNSTART_CACHE,
                                    self._DESCRIPTOR_CACHE,
                                    self.config['timezone'],
                                    **kwargs)
        for ev in gen:
    ...
    def find_last(self, num=1):
        ...
        for ev in self._api.find_last(self._RUNSTART_CACHE,
                                      num=num):
            yield ev
...
class MDS(MDSRO):
    ...
    def insert_run_start(self, time, uid, **kwargs):
        ...
        run_start : str
            ...
            the full document.
        '''
        return self._api.insert_run_start(self._RUNSTART_CACHE,
                                          time=time,
                                          uid=uid,
                                          **kwargs)
    ...
    def insert_run_stop(self, run_start, time, uid, exit_status='success',
        ...
        """
        return self._api.insert_run_stop(self._RUNSTART_CACHE,
                                         self._RUNSTOP_CACHE,
                                         run_start=run_start,
                                         time=time, uid=uid,
    ...
    def insert_descriptor(self, run_start, data_keys, time, uid, **kwargs):
        ...
        descriptor : str
            uid of inserted Document
        """
        return self._api.insert_descriptor(self._RUNSTART_CACHE,
                                           self._DESCRIPTOR_CACHE,
                                           run_start=run_start,
                                           data_keys=data_keys,
                                           time=time, uid=uid,
    ...
    def insert_event(self, descriptor, time, seq_num, data, timestamps, uid,
        ...
        if self.version == 0:
            return self._api.insert_event(descriptor=descriptor,
    ...
    def bulk_insert_events(self, descriptor, events, validate=False):
        ...
        if self.version == 0:
            return self._api.bulk_insert_events(descriptor=descriptor,
                                                events=events,
                                                validate=validate,
                                                descriptor_cache=self._DESCRIPTOR_CACHE,
                                                start_cache=self._RUNSTART_CACHE)
