...
According to this file, each ArchiverEventSource is defined with
three configuration key-value pairs :
...
After integrating ArchiverEventSources with :class:`Broker`, PV data can
be retrieved with the standard :meth:`Header.table` method:
